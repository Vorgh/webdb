...
public class ControllerExceptionHandler
{
    ...
    public ResponseEntity<GeneralError> illegalArgumentException(final IllegalArgumentException e) //Wrong parameters
    {
    ...
    public ResponseEntity<GeneralError> illegalStateException(final IllegalStateException e) //DB is unreachable
    {
        logger.error(e.getMessage());
