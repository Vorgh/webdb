...
public interface ProcedureService
{
    ...
    Procedure getProcedure(String schemaName, String procedureName, UserConnection connection);
    ...
    void dropProcedure(String schemaName, String procedureName, UserConnection connection);
}
